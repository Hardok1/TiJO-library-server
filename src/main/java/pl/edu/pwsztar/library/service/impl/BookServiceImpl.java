...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public boolean addBook(String name, String description, String bookImageUrl, Double price, List<Long> authorsId, int quantity) {
        ...
        if (authors.size() > 0) {
            ...
            bookCopyService.addNewBookCopies(book.getId(), quantity);
            return true;
        }
        return false;
    }
    ...
    @Override
    public boolean editBook(Long bookId, String name, String description, String bookImageUrl, Double price, List<Long> authorsId) {
